package br.com.marcelo.response;
...
public class Cambio implements Serializable {
	...
	public String getEnironment() {
		return enironment;
	}

	public void setEnironment(String enironment) {
		this.enironment = enironment;
	}

	@Override
	public int hashCode() {
		return Objects.hash(conversionFactor, convertedValue, enironment, from, id, to);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(conversionFactor, other.conversionFactor)
				&& Objects.equals(convertedValue, other.convertedValue) && Objects.equals(enironment, other.enironment)
